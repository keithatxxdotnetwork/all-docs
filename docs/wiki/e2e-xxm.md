...
your message content private from third parties, including cMix nodes,
...
needs the xx contact (public cryptographic identity key) to establish
...
After acquiring the other users’ xx contact, the xx messenger sends an
