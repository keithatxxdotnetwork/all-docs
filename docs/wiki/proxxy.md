...
with a given blockchain and sends them over cMix to the Relay server.
...
generated by the server when connecting to the cMix network.
...
[^1]: <https://support.metamask.io/hc/en-us/articles/10992445334555-Does-MetaMask-collect-my-personal-data->
