...
<details>
  ...
  - **nvidia-driver-[version]-server** and dependencies are for GPU and computation.
...
```jsx title="Copy and run ..."
sudo apt install -y curl python3-pip postgresql-client postgresql postgresql-contrib nvidia-driver-525-server
```
